...
$(document).ready(function() {
	...
	$("#hidden-table-container").append(CreditReportExtractor.getCalculatorSheet());

	$("#download").click(function() {
		var tables = ["calculator-worksheet", "closed-accounts", "installment-accounts"],
			names = ["bank account", "closed account", "installment account"];
